  ...
  return (
    <section className="pt-[90px]">
      <div className="flex flex-col gap-5 relative">
        ...
        <div className="hidden md:block absolute inset-0 bg-gradient-to-b from-black via-purple-700/50 to-black rounded-lg -z-10"></div>
        ...
        <div className="text-white text-center px-[16px] flex flex-col gap-5 items-center">
